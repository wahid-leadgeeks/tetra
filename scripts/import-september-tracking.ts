 ...
 *
 * Usage:
 *   pnpm tsx --env-file=.env.local scripts/import-september-tracking.ts [--email=user@example.com] [--name=User]
 */
...
async function main() {
  ...
  const worksheetName = process.env.GOOGLE_SHEET_NAME || "Sheet1";
